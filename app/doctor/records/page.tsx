      ...
      <aside className="hidden w-72 border-r border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-800 lg:flex flex-col">
        ...
        <nav className="flex-1 space-y-1 px-4">
          {[
            ...
            { label: "Records", icon: Clipboard, href: "/doctor/records", active: true },
        ...
        <main className="flex-1 overflow-y-auto p-10 space-y-10">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm font-medium text-slate-400">Access and manage patient records</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {records.map((record) => (
              <div key={record.id} className="flex flex-col gap-4 rounded-3xl border border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 hover:border-blue-200 dark:hover:border-blue-700 cursor-pointer transition-all shadow-sm">
                <div className="flex items-start justify-between">
                  <div className="h-12 w-12 rounded-2xl bg-slate-50 dark:bg-slate-700 flex items-center justify-center text-slate-400">
                    <FileText className="h-6 w-6" />
                  </div>
                  <button className="rounded-xl border border-slate-100 dark:border-slate-700 p-2 text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all">
                    <Download className="h-4 w-4" />
                  </button>
                </div>
                <div className="flex-1">
                  <p className="text-sm font-black text-slate-800 dark:text-slate-100 mb-1">{record.patient}</p>
